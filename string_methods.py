...
print(s.capitalize())  #This just capitalized the first letter in our word "hello"

print("HELLO".casefold()) #This just de-capitalizes the capital letters. (Same as the .lower() method.
